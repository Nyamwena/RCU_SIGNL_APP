  ...
  return (
    <div style={{ marginTop: '2em' }}>
      <div className="jumbotron text-center">
        <h1 >Reformed Church University Sign Language Translation App - ZSL Translator</h1>
        <h4>
          ...
          texts below detail the steps taken for Reformed Church University Sign Language Translation App to translate an image
          into a final word.
        </h4>
      </div>
